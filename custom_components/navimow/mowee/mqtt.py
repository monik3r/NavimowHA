...
class MowerMQTT:
    ...
    def _get_location_topic(self, device_id: str) -> str:
        ...
        """
        # TODO: 根据实际 MQTT topic 格式调整
        return f"device/{device_id}/location"

    def _get_attributes_topic(self, device_id: str) -> str:
        """Get device attributes topic。
        ...
        """
        # TODO: 根据实际 MQTT topic 格式调整
        return f"device/{device_id}/attributes"
    ...
    async def async_subscribe_device(
        ...
        attributes_topic = self._get_attributes_topic(device_id)
    ...
    def subscribe_device(
        ...
        try:
            ...
            self._sync_client.subscribe(attributes_topic)
...
class NavimowMQTT:
    ...
    def subscribe_all(self, product_key: str, device_name: str) -> None:
        ...
        _LOGGER.info(
            "NavimowMQTT asd subscribing cloud topics for %d device(s)", len(device_ids)
        )
        for device_id in device_ids:
            ...
            self.client.subscribe(
                f"/downlink/vehicle/{device_id}/realtimeDate/#"
            )
            self.client.subscribe(f"/downlink/vehicle/{device_id}/realtimeDate/#")
